...
if(isset($_POST['btn-signup']))
{
	...
	mysql_query("INSERT INTO news(news_title,news_img_url,news_category,news_description,news_date) VALUES('$title','$img_url','$category','$desc','$date')");
...
<div class="panel-body">
              <div class="row">
                ...
                <div class="col-md-7">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Image URL" name="img_url" required>
                      </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <textarea type="text" class="form-control" placeholder="News Description" rows="10" name="desc" required></textarea>
                      </div>
